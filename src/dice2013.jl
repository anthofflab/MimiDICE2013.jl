...
function constructdice(p)
    ...
    connect_param!(m, :damages, :TATM, :climatedynamics, :TATM, offset=0)
    connect_param!(m, :damages, :YGROSS, :grosseconomy, :YGROSS, offset=0)
    ...
    connect_param!(m, :neteconomy, :DAMAGES, :damages, :DAMAGES, offset=0)
